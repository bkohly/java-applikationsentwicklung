...
public class IntArrayExtensions {
     ...
     */
    static public int[] getRandomNumbersInRange(int size, int min, int max){
        Random random = new Random();
        return random.ints(size, min, max).toArray();
    }
    static public int getMax(int[] elements) {
        int max = 0;
    ...
    static public int getMin(int[] elements) {
        int min = 0;
        for (int element : elements){
            if (element <= min){
                min = element;
    ...
    static public double getAverage(int[] elements) {
        double average = 0;
        for (int element : elements){
            average += element;
        }
    ...
    static public int[] sort(int[] elements) {
        boolean sort = true;
    ...
    static public  int[] reverse(int[] elements) {
        int j = 0;
    ...
    static public int[] mix(int[] elements) {
